              ...
              <div className={InnerContainerStyle}>
                ...
                <div className='flex items-center justify-center flex-col'>
                  ...
                  <div className='w-[280px] mt-[24px] md:w-[440px] md:mt-[70px] flex items-center justify-center flex-col'>
                    ...
                    <h1 className='text-2xl md:text-4xl font-semibold text-darkblue'>Sign Up</h1>
                      <p className='text-sm text-darkgray'>Enter your email and password to sign up!</p>
                    </div>
                    ...
                    <SocialLoginButton icon={xLogo} text='Sign in with X' className='flex justify-center items-center gap-2 w-[280px] md:w-[210px] h-[44px] bg-lightgray rounded-lg cursor-pointer'/></div>
              
              <div className='flex items-center justify-center h-[34px] my-[12px] md:my-[20px] font-normal text-xs text-mediumgray'>Or</div>
